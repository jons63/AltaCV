...
* Follow the instructions [here](https://miktex.org/howto/miktex-docker)
* Example command `docker run -ti -v miktex:/miktex/.miktex -v C:/git/AltaCV:/miktex/work miktex/miktex pdflatex jongar.tex`
